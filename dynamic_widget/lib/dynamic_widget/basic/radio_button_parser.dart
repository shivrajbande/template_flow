...
class RadioButtonListTileParser extends WidgetParser {
  ...
  Map<String, dynamic>? export(Widget? widget, BuildContext? buildContext) {
    if (widget != null && widget is RadioListTile) {
      ...
      final Map<String, dynamic>? secondary =
          DynamicWidgetBuilder.export(widget.secondary, buildContext);
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    final Widget? secondary = DynamicWidgetBuilder.buildFromMap(
        map['secondary'], buildContext, listener, projectInfo);
    ...
    final FontWeight selectedFontWeight =
        parseFontWeightDetails(map['SelectedfontWeight']);
    ...
    double? unselectedLetterSpacing =
        map['unselectedLetterSpacing']?.toDouble();
...
// print("jhsgjv $options");
    ...
    RadioParams params = new RadioParams(
        options,
        controlAffinity,
        activeColor!,
        optionheight,
        ...
        unselectedLetterSpacing!,
        selectedLineHeight!,
        unselectedLineHeight!,
...
class RadioParams {
  ...
  RadioParams(
      ...
      this.selectedLetterSpacing,
      this.selectedLineHeight,
      this.unselectedLetterSpacing,
      this.unselectedLineHeight,
...
class _CustomRadioClassState extends State<CustomRadioClass> {
            ...
            itemBuilder: (context, index) {
              ...
              return SizedBox(
                ...
                child: RadioListTile(
                  ...
                  title: Text(option,
                      style: (option == params!.initialRadioOption)
                          ? myselectedstyle
                          : mystyle),
                  fillColor: option != (params!.initialRadioOption)
                      ? MaterialStatePropertyAll(params!.fillColor)
                      : null,
  ...
  TextStyle unselectedStyle(String enteredFont) {
    switch (enteredFont) {
      case 'Roboto Slab':
        return GoogleFonts.robotoSlab(
            color: params!.unselectedTextColor,
            fontWeight: params!.fontWeight,
            fontSize: params!.unselectedFontSize,
            letterSpacing: params!.selectedLetterSpacing,
            height: params!.selectedLineHeight);
      case 'Mukta':
  ...
  TextStyle selectedStyle(String enteredFont) {
    switch (enteredFont) {
      case 'Roboto Slab':
        return GoogleFonts.robotoSlab(
            color: params!.selectedTextColor,
            fontWeight: params!.selectedFontWeight,
            fontSize: params!.selectedFontSize,
            letterSpacing: params!.unselectedLetterSpacing,
            height: params!.unselectedLineHeight);
      case 'Mukta':
        return GoogleFonts.mukta(
            color: params!.selectedTextColor,
            fontWeight: params!.selectedFontWeight,
